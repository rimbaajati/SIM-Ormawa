<template>
  <div class="p-6 bg-[#0f1624] min-h-screen text-white">
    <h1 class="text-3xl font-extrabold mb-6 text-white/90">Manajemen Berita</h1>

    <!-- Tombol Tambah -->
    <NuxtLink to="/berita/tambah" 
      class="bg-[#FFA500] text-[#08101a] font-semibold px-5 py-2 rounded-lg shadow-md hover:bg-[#FF8C00] transition duration-200"
    >
      + Tambah Berita Baru
    </NuxtLink>
    ...
    <div class="mt-8">
      ...
      <div v-else-if="!berita || berita.length === 0" class="text-center py-12 border border-white/10 bg-[#0f1624] p-6 rounded-lg">
